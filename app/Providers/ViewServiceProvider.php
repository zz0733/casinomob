...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('*', function ($view) {
            ...
            $_api_list = Api::where('on_line', 0)->orderBy('created_at', 'desc')->select('api_name', 'type')->get()->toArray();
            \Log::info('api_list: '.json_encode($_api_list));

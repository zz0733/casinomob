...
function click_url(r,k){
	if(k==1){
		...
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","318px");
		...
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","-122px");
